...
namespace ShopHeaven.Migrations
{
    ...
    [Migration("20230705135224_createBulletinSubscriptionModel")]
    partial class createBulletinSubscriptionModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopHeaven.Data.Models.BulletinSubscription", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("BulletinSubscriptions");
                });
            ...
            modelBuilder.Entity("ShopHeaven.Data.Models.Currency", b =>
                {
                    ...
                    b.Property<bool>("IsCurrentForApplication")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ShopHeaven.Data.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("TotalPriceWithDiscountCouponAndShippingTax")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ShopHeaven.Data.Models.ShippingMethod", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShopHeaven.Data.Models.Order", b =>
                {
                    ...
                    b.HasOne("ShopHeaven.Data.Models.ShippingMethod", "ShippingMethod")
                        .WithMany()
